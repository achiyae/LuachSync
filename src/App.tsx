...
const TAB_TITLES: Record<AppTabId, string> = {
  dashboard: 'Χ™Χ•ΧÿΧÿ ΧΆΧ‘Χ¨Χ™ ΧÿΧ™Χ•ΧÿΧÿ Χ’Χ•Χ’Χÿ',
  calendar: 'ΧÿΧ•Χ— Χ©Χ Χ”',
  'add-event': 'Χ”Χ•Χ΅Χ¤Χª ΧÿΧ™Χ¨Χ•ΧΆ',
  'import-export': 'Χ™Χ™Χ¦Χ•Χÿ Χ•Χ™Χ™Χ‘Χ•Χÿ',
  support: 'ΧªΧÿΧ™Χ›Χ” Χ•ΧΆΧ–Χ¨Χ”',
  privacy: 'ΧÿΧ“Χ™Χ Χ™Χ•Χª Χ¤Χ¨ΧΧ™Χ•Χª',
  terms: 'ϊπΰι ωιξεω',
};
...
export default function App() {
  ...
  const requestTabChange = (nextTab: AppTabId) => {
    if (activeTab === 'import-export' && isImportExportSyncing && nextTab !== 'import-export') {
      const shouldLeave = window.confirm('Χ”Χ΅Χ Χ›Χ¨Χ•Χÿ ΧÿΧ™Χ•ΧÿΧÿ Χ’Χ•Χ’Χÿ ΧΆΧ“Χ™Χ™Χÿ Χ¤ΧΆΧ™Χÿ. Χ™Χ¦Χ™ΧÿΧ” ΧÿΧÿΧ΅Χÿ Χ–Χ” ΧªΧΆΧ¦Χ•Χ¨ ΧÿΧª Χ”ΧªΧ”ΧÿΧ™Χÿ. ΧÿΧ”ΧÿΧ©Χ™Χÿ?');
      if (!shouldLeave) {
        return;
      }
    }
